...
![alt text](https://github.com/Shyjojose/differential_picker_robot/blob/main/screenshot/SCREEN2.png)

    $ roslaunch finaldesign_description  slam.launch

! need to add displays in the riviz tool 

![alt text](https://github.com/Shyjojose/differential_picker_robot/blob/main/screenshot/screen3.png)
...
![alt text](https://github.com/Shyjojose/differential_picker_robot/blob/main/screenshot/screen4.png)
...
![alt text](https://github.com/Shyjojose/differential_picker_robot/blob/main/screenshot/screen5.png)
